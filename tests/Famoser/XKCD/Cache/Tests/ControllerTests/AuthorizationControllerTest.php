...
use Famoser\XKCD\Cache\Models\Communication\Entities\DeviceCommunicationEntity;
...
class AuthorizationControllerTest extends ApiTestController
{
    ...
    public function testUserNotFound()
    {
        ...
        //arrange
        AssertHelper::checkForFailedApiResponse($this, $response, DownloadStatus::USER_NOT_FOUND);
    }
    ...
    public function testDeviceNotFound()
    {
        ...
        //arrange
        AssertHelper::checkForFailedApiResponse($this, $response, DownloadStatus::DEVICE_NOT_FOUND);
    }
    ...
    public function testAddSecondDevice()
    {
        ...
        $response = $this->testHelper->getTestApp()->run();
        AssertHelper::checkForFailedApiResponse($this, $response, DownloadStatus::DEVICE_NOT_AUTHORIZED);
    }
